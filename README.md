...
```
 ...
 ╰──────────────────────────────────────────────────────────────╯
 /help 명령 목록   /think 추론 강도   Ctrl+C 끝내기
...
> 검증: `npm test` 의 network·web 검사 54항목. 허용되지 않은 서버에 실제로 요청이
...
출력 상한을 아끼다 대답이 잘리면 **그 단계만 상한을 풀어 자동으로 다시 부릅니다.**
