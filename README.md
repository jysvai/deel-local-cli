...
<details>
<summary><b>자세히</b> — 걸린 모델에 맞춰 스스로 바뀝니다 · 국산 모델은 겪기 전에 압니다 · 작은 창에서는 고정 몫을 줄입니다 · 켤 때 이 폴더가 무슨 프로젝트인지 읽습니다</summary>
...
<details>
<summary><b>자세히</b> — 인코딩 · 엑셀 · hwpx/docx/pptx</summary>
...
잃습니다. 구형 `.hwp`(OLE)는 못 읽는 대신 **한글에서 hwpx 로 저장하면 읽힌다**는
길을 같이 알려 줍니다.
