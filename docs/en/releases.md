...
|---|---|---|
| **[1.19.x](releases/1.19.md)** | [1.19.0](releases/1.19.md#1190) | Getting one side right broke the other — eleven rounds of second review, and checks that measure both sides |
