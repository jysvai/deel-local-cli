...
|---|---|---|
| **[1.19.x](releases/1.19.md)** | [1.19.2](releases/1.19.md#1192) · [1.19.1](releases/1.19.md#1191) · [1.19.0](releases/1.19.md#1190) | Getting one side right broke the other — thirteen rounds of second review, and the gap left where a fence moved |
