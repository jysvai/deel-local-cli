...
|---|---|---|
| **[1.19.x](releases/1.19.md)** | [1.19.1](releases/1.19.md#1191) · [1.19.0](releases/1.19.md#1190) | Getting one side right broke the other — twelve rounds of second review, and what was deliberately not fixed |
