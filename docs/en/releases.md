...
|---|---|---|
| **[1.17.x](releases/1.17.md)** | [1.17.3](releases/1.17.md#1173) · [1.17.2](releases/1.17.md#1172) · [1.17.1](releases/1.17.md#1171) · [1.17.0](releases/1.17.md#1170) | The things that blocked it from getting inside a company — and the company writes what to do |
