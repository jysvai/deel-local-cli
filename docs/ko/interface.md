...
| 방 안의 것 | 무슨 값인가 |
|---|---|
| 자리에 앉은 사람 수 | 지금 **동시에** 도는 일 — 한꺼번에 도는 읽기 도구 수 + 하위 작업 수 |
| 자세 | 무슨 일을 하는 중인가 — 자판(쓰기)·서류(읽기)·조는 중(45초 초과) |
...
사무실 열두 줄에서 그 수는 평균 **0.5줄쯤**입니다 — 벽·창문·서류함·빈 책상은
안 바뀌고, 사람이 있는 줄만 바뀝니다. 이 값은 `test/office.test.js` 가 잽니다.

| | |
|---|---|
| 판마다 바뀌는 줄 | 12줄 중 평균 **0.5줄쯤** |
