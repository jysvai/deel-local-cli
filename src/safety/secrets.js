...
export const 갈래 = [
  ...
  },
  {
    ...
    id: '환경변수',
    re: /\b([A-Z][A-Z0-9_]{2,}(?:KEY|TOKEN|SECRET|PASSWORD|PASSWD|PWD|CREDENTIALS?))(["']?\s*[:=]\s*)((?:\(\s*)+)?(?:(["'])(?!«)([^"'\n]{4,}?)\4|(?!«)(?![A-Za-z_$][\w$]*\s*\()(?!\(*\s*(?:process\.env|import\.meta\.env|globalThis\.process\.env|globalThis\.env|os\.environ|os\.getenv|ENV(?=\s*[[.(])|Deno\.env|Bun\.env)\b)([^\s"'()\[\]{},;]{4,}))((?:\s*\))+)?/g,
