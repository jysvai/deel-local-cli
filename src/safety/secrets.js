...
export const 갈래 = [
  ...
  },
  {
     ...
     * 쌍점부터 등호까지고, 그 사이에 따옴표·등호·세미콜론·줄바꿈이 없으면
     * 그게 타입 자리다.
     *
     *   · 따옴표가 없어야 한다  — 있으면 그건 타입이 아니라 값이다.
     *   · 등호가 없어야 한다    — 있으면 거기가 진짜 대입 자리다.
     *   · 세미콜론·줄바꿈이 없어야 한다 — 있으면 문장이 이미 끝났다.
     *
     * ── 쉼표만 두 갈래로 본다 ────────────────────────────────────────
     *
     ...
     *
     * 그래서 쌍점 갈래를 둘로 둔다. 쉼표가 없으면 그냥 등호까지 가고,
     * 쉼표가 있으면 **등호 바로 앞이 닫는 괄호**여야 한다.
     *
