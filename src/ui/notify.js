...
/*
 * 제목을 터미널에 도로 맡긴다 — 남의 터미널을 우리 이름으로 두고 나가지 않는다.
 *
 * 켤 때 있던 제목을 그대로 되살리지는 못한다. 그것을 알려면 터미널에 물어야 하는데
 * (OSC 21), 답하는 터미널이 얼마 없고 안 답하면 그 답을 기다리다 멈춘다. 빈 제목을
 * 보내면 터미널·셸이 제 규칙대로(대개 셸 프롬프트가 다시 정한다) 채운다.
 */
