...
import { c, clip, cols, 화면글거르기 } from './ansi.js';
...
// 줄은 **파일 내용**이다 — 남의 파일에 든 터미널 제어 순서를 먼저 뗀다(ansi.js 화면글거르기 머리말).
// 탭은 그 뒤에 칸으로 편다. 거르개는 탭을 남기고 \r 은 뗀다.
const 보기좋게 = (s) => 화면글거르기(s).replace(/\t/g, TAB);
