...
export const ko = {
  ...
  'approve.newFile': '새 파일',
  'approve.locked': '관리 정책이 승인을 {바닥} 아래로 못 내리게 걸어 두었습니다 — {곳}',
  'approve.lockedUnknown': '관리 정책의 approval 값 "{값}" 을 몰라 제일 좁은 strict 로 칩니다 — {곳}',
  'approve.noAlways': '관리 정책이 승인을 걸어 두어 「앞으로 묻지 않기」 는 없습니다',
  'work.title': '작업 모드',
  'work.canEdit': '파일 바꿈',
  'work.readOnly': '읽기만',
  'work.think': '생각',
  ...
  'stats.undos': '되돌리기',
  'stats.masked': '비밀 가림',
  'stats.broken': '읽지 못한 줄이 {n}개 있습니다 — 위 숫자는 그만큼 덜 셌습니다.',
  'stats.older': '기간 밖에 {n}줄이 더 있습니다 (--all 로 전부).',
  ...
  'plan.timedOut': '{초}초 동안 답이 없어 계획대로 진행합니다.',
  'plan.autoGo': '자율 모드라 묻지 않고 계획대로 진행합니다.',
  ...
  'ask.autoWait': '{초}초 안에 답이 없으면 알아서 진행합니다',
  'ask.timedOut': '{초}초 동안 답이 없어 알아서 진행합니다.',
  'ask.autoSkip': '자율 모드라 묻지 않고 진행합니다 — {물음}',
  ...
  'ev.phaseMove': '{왜} — 여기서부터 {옛} 대신 {새} 로 갑니다',
  'ev.phaseWhyEdit': '파일을 바꾸기 시작했습니다',
  'ev.phaseWhyTodo': '할 일을 다 적었습니다',
  'ev.phaseTools': '도구가 늘었습니다 ({도구}) — 앞머리를 한 번 다시 씁니다',
  'ev.noNews': '{초}초간 살아 있다는 신호만 오고 내용은 안 왔습니다 — 게이트웨이가 윗모델을 기다리는 중일 수 있습니다',
  'ev.noNewsCap': '{상한초}초까지 기다리고 끊습니다. 오래 걸리는 게 맞으면 설정의 무소식 을 올리세요',
  ...
  'ev.hookNote': '훅: {말}',
  'ev.hookBlock': '훅이 막았습니다',
  'ev.nudgeRead': '읽기만 하고 끝내려고 해서 한 번 되밀었습니다',
  'check.start': '완료 검사 ({판}/{최대}) — {명령}',
  'check.pass': '완료 검사 통과 — {명령}',
  'check.fail': '완료 검사 실패 ({판}/{최대}) — {요약}',
  'check.retry': '실패 내용을 돌려주고 다시 고치게 합니다',
  'check.gaveUp': '{판}번 돌렸는데도 실패했습니다 — 실패로 끝냅니다',
  'check.skipped': '완료 검사를 못 돌렸습니다 — {까닭}',
  'cli.checkFlag': '끝내려 할 때 이 검사를 돌려 통과해야 끝남 (실패하면 고치게 하고, 끝내 실패면 8)',
  'cli.evalTitle': '골든셋',
  'cli.evalWhy': '— 과제 모음을 실제 모델로 돌려 몇 개를 해내나 잽니다',
  'cli.evalInit': '예제 과제 다섯을 golden/ 에 만듭니다',
  'cli.evalRun': '과제마다 임시 폴더에서 deel run 을 돌리고, 끝난 뒤 정답 검사로 채점합니다',
