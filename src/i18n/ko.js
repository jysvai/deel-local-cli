...
export const ko = {
  ...
  'work.steps': '최대 {n}걸음',
  'work.tools': '도구',
  'work.toolsWrite': '읽기 + 파일 바꾸기',
  'work.toolsRead': '읽기만 — 파일을 못 바꿉니다',
  'work.howTo': '바꾸려면 {a} {b} {c} …  또는 {키} 로 차례로',
  'work.axis': '이건 승인 정책({명령})과 다른 축입니다 — 무엇을 하느냐 / 얼마나 물어보냐.',
  'work.autoOn': '앞으로는 한마디마다 알맞은 모드로 저절로 옮겨 갑니다.',
  'work.pinned': '직접 고르셨으므로 저절로 바뀌지 않습니다. 다시 맡기려면',
  'trust.ignored': '이 폴더의 프로젝트 설정을 안 읽었습니다 — 아직 믿는 폴더가 아닙니다',
  'trust.ignoredWhy': '설정 파일은 저장소에 딸려 옵니다. 남의 것을 그냥 읽으면 주소도 열쇠 받는 명령도 그쪽이 정합니다.',
  'trust.howTo': '읽게 하려면',
  'trust.filtered': '프로젝트 설정에서 못 정하는 칸을 걷어냈습니다',
  'trust.trusted': '이 폴더의 프로젝트 설정을 읽습니다',
  'trust.already': '이미 믿는 폴더입니다',
  ...
  'cost.elapsed': '경과',
  'cost.money': '요금',
  // ── 캐시·전선·자동 강도 (backend/wire.js · backend/cachemark.js) ──────
  'status.wire': '전선',
  'wire.think': '생각',
  ...
  'cost.cacheLine': '읽음 {읽음} · 씀 {씀} · 적중 {몫}%',
  'cost.cacheColdWarn': '쓰기만 있고 읽기가 없습니다 — 앞머리가 매번 새로 엮이는 중입니다',
  'think.auto': '자동',
  'think.autoNote': '정한 값은 천장입니다 ({천장}) — 가벼운 말은 {지금} 까지 낮춰 씁니다',
  'think.autoOn': '시킨 말에 맞춰 강도를 고릅니다 — 정한 값이 천장이 됩니다',
